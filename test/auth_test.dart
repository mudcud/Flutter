...
void main() {
  group('Mock Authentication', () {
    ...
    test('logged in user shud be able to get verified',(){
    ...
    test('Shoiuld be able to log aut and login again', () async{
...
class MockAuthProvider implements AuthProvider {
  AuthUser? _user;
  var _isInitialized = false; // Using underscore before show the property is private to Mock.NOT accessed by other
  ...
  Future<AuthUser> login({
    ...
    if (!isInitialized) throw NotInitializedException();
    if (email == 'wetexy@gmail.com') throw UserNotFoundAuthException();
    if (password == '12345') throw WrongPasswordAuthException();
    const user = AuthUser(isEmailVerified: false, email: 'wetexy"gmail.com');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser = AuthUser(
      isEmailVerified: true, email: 'wetexy@gmail.com');
    _user = newUser;
  }
